...
--   /admin/tournaments/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa/documents
...
insert into tournaments (id, division_id, fiscal_year, title, event_date, venue, summary, is_published) values
